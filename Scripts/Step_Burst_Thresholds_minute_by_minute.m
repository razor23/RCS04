...
for G=1:length(Groups)
    ...
    for f=1:length(OFFfiles)
        try
            ...
            s=1;
            [b,a] = butter(4,[3,7]/(250/2)); % 4th order butterworth filter
            ...
            Thresh1=prctile(t1amp,75);  % gets value of 75th percentile
            Thresh2=prctile(t2amp,75);  % gets value of 75th percentile
            Thresh3=prctile(t3amp,75);  % gets value of 75th percentile
